...
class QuadProfile(Profile):
    '''
    Класс расчета АДХ четырехугольного профиля
    '''
    ...
    def K_w(self) -> float:
        ...
        # Коэффициент, представляющий собой отношение коэффициента силы волнового сопротивления четырехугольного профиля к коэффициенту силы волнового сопротивления ромбовидного профиля изолированного крыла бесконечного размаха [-]
        K_w = 1 / (4 * self.xx_c * (1 - self.xx_c))
