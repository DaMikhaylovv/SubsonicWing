...
class SinProfile(Profile):
    '''
    Класс расчета АДХ синусоидального профиля
    '''
    ...
    def __init__(self, b: float, cc: float, xx_c: float, rr_0: float, hb: float) -> None:
        ...
        super().__init__(b, cc, xx_c, rr_0, hb) #? а зачем xx_c если понятно что она 0.5? И в других тоже?
    ...
    def M_cr(self, c_y: float = 0) -> float:
        ...
        # Критическое число Маха сверхзвуковых чечевицеобразных профилей на 3-5% ниже
        M_cr = AeroBDSM.get_Mcr_pr(self.cc, abs(c_y), self.xx_c).Value * 0.95
    ...
    def K_w(self) -> float:
        ...
        # Коэффициент, представляющий собой отношение коэффициента силы волнового сопротивления синусоидального профиля к коэффициенту силы волнового сопротивления ромбовидного профиля изолированного крыла бесконечного размаха [-]
        K_w = pi ** 2 / 8
