...
class ArcProfile(Profile):
    '''
    Класс расчета АДХ профиля, образованного дугами окружности или параболы
    '''
    ...
    def K_w(self) -> float:
        ...
        # Коэффициент, представляющий собой отношение коэффициента силы волнового сопротивления синусоидального профиля, образованным дугами окружности или параболы, к коэффициенту силы волнового сопротивления ромбовидного профиля изолированного крыла бесконечного размаха [-]
        K_w = 4 / 3
