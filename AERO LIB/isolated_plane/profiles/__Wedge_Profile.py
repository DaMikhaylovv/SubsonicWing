...
class WedgeProfile(Profile):
    '''
    Класс расчета АДХ клиновидного профиля    
    '''
    ...
    def __init__(self, b: float, cc: float, xx_c: float, rr_0: float, hb: float) -> None:
        ...
        Ввод:   b: float - длина хорды крыла, м
                cc: float - относительная толщина профиля крыла в долях рассматриваемой хорды
                ...
                hb: float - относительная высота бугорков шероховатой поверхности тела в долях рассматриваемой хорды
        Вывод:  ...
        '''
    ...
    def K_w(self) -> float:
        ...
        # Коэффициент, представляющий собой отношение коэффициента силы волнового сопротивления клиновидного профиля к коэффициенту силы волнового сопротивления ромбовидного профиля изолированного крыла бесконечного размаха [-]
        K_w = 1 / 4
